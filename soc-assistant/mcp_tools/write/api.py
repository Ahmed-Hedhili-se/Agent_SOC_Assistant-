...
In this prototype every tool is simulated: it returns a result dict and
emits an audit entry, matching what a real write action would report back
to the HITL layer, without touching any real system.
"""
